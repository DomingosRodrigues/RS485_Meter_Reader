...
void getPrintAll(){
    ...
    getActivePower();
    getActivePower();
    Apower          = getActivePower();

    getReactivePower();
    getReactivePower();
    Rpower          = getReactivePower();

    getApparentPower();
    getApparentPower();
    APpower         = getApparentPower();

    getPowerFactor();
    getPowerFactor();
    Pfactor         = getPowerFactor();

    getTotalApparentPower();
    getTotalApparentPower();
    TApower         = getTotalApparentPower();

    getExportActivePower();
    getExportActivePower();
    ExportActive    = getExportActivePower();

    getImportReactivePower();
    getImportReactivePower();
    ImportReactive  = getImportReactivePower();

    getExportReactivePower();
    getExportReactivePower();
    ExportReactive  = getExportReactivePower();
    // Frequency       = getFrequency();
    // delay(50);
    // Voltage         = getVoltage();
    // delay(50);
...
void loop()
{
  if (millis()> next_print){
    getPrintPublishAll();
    next_print = millis()+POST_EVERY_MS;
  }
}